...
latex_documents = [
    (master_doc, 'rules-c.tex', 'rules-c Documentation',
     ' Groupe F', 'manual'),
]
...
man_pages = [
    (master_doc, 'rules-c', 'rules-c Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, ' Groupe F', 'rules-c Documentation',
     author, 'rules-c', 'project C Groupe F',
     'Miscellaneous'),
]
